...
<head runat="server">
    <meta charset="UTF-8">
	<title>Test Drive Information | Official</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
           ...
           <div class="form-horizontal">
                <h2>Fill the form for Test Drive</h2>
                <hr />
            </div>
            ...
            <div class="center-page">
                ...
                <div class="col-xs-11">
                    <asp:TextBox ID="tbFullName" runat="server" class="form-control" placeholder="Full Name" Width="443px"></asp:TextBox>
                </div>

                <label class="col-xs-11">E-mail</label>
                <div class="col-xs-11">
                    <asp:TextBox ID="tbEmail" runat="server" class="form-control" placeholder="E-mail" TextMode="Email" Width="443px"></asp:TextBox>
                </div>

                <label class="col-xs-11">NID</label>
                <div class="col-xs-11">
                    <asp:TextBox ID="tbNid" runat="server" class="form-control" placeholder="Enter NID" TextMode="Number" Width="441px"></asp:TextBox>
                </div>

                <label class="col-xs-11">Contact Number</label>
                <div class="col-xs-11">
                    <asp:TextBox ID="tbContactNumber" runat="server" class="form-control" placeholder="Contact Number" TextMode="Phone" Width="442px"></asp:TextBox>

                </div>

                <label class="col-xs-11">Address</label>
                <div class="col-xs-11">
                    <asp:TextBox ID="tbAddress" runat="server" class="form-control" placeholder="Address" Width="442px"></asp:TextBox>

                </div>
                <label class="col-xs-11">Date</label>
                <div class="col-xs-11">
                    <asp:TextBox ID="tbDate" runat="server" class="form-control" placeholder="format dd/mm/yyyy" Width="442px"></asp:TextBox>

                </div>

                <div class="col-xs-11 space-vert">
                    <asp:Button ID="btnSignup" runat="server" Text="Submit" class="btn btn-primary" OnClick="btnSignup_Click" Width="138px" />
                    <asp:Button ID="btnReset" runat="server" Text="Reset" class="btn btn-danger" OnClick="btnReset_Click" Width="130px" />
