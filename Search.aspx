...
<head runat="server">
    <meta charset="UTF-8">
	<title>Search Results | Official</title>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <asp:Button ID="ButtonBuy" runat="server" cssClass="btn btn-primary" Text="TestDrive" OnClick="ButtonBuy_Click" />
                                    <asp:Button ID="ButtonDetails" runat="server" cssClass="btn btn-default" Text="Details" OnClick="ButtonDetails_Click" CommandArgument='<%#Eval("Id") %>'/>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
