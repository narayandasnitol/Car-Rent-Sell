...
public partial class ViewCarRentOrder : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if(e.CommandName == "approve")
        {
            ...
            {
                SqlCommand command = new SqlCommand("update RegistrationInfo set OrderRequest = '" + a + "'where Id = '" + id + "'", con);
        ...
        else
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                //Fetching Email Body Text from EmailTemplate File.  
                string FilePath = "C:\\Users\\Nitol Das Neel\\Documents\\Visual Studio 2017\\Projects\\CarRentSell2018\\CarRentSell2018\\EmailTemplates\\SignUp4.html";
                StreamReader str = new StreamReader(FilePath);
                string MailText = str.ReadToEnd();
                str.Close();
