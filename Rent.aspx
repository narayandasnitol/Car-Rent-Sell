...
<head runat="server">
  <meta charset="UTF-8">
	<title>Rent a Car | Official</title>
                ...
                <asp:Repeater ID="RepeaterProduct" runat="server">
                    <ItemTemplate>
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail">
                                <img src="Images/ProductImage/0/<%#Eval("ImageName") %><%#Eval("Extension") %>" alt="<%#Eval("ImageName") %>" />
                                <div class="caption">
                                    <h2><%#Eval("CarName") %></h2>
                                    <h4>Model- <%#Eval("CarModel") %></h4>
                                    <p>Rent/Hour - <%#Eval("CarPrice") %></p>
                                    <p style="color: green; font-weight: 600">Available - <%#Eval("Available") %></p>
                                    <asp:Button ID="ButtonBuy" runat="server" CssClass="btn btn-primary" Text="Order for Rent" OnClick="ButtonOrderRent_Click" Width="235px" CommandArgument='<%#Eval("Id") %>'/>
